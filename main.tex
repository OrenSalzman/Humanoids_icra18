...
Furthermore, the human guidance used was used as a ``hard'' constraint forcing the system to make use of the guidance.
...
This requires characterizing regions where the planner ceases to make progress an algorithmic tools to detect such regions. 
...
\ToDo{
Describe when these two notions are used (real-time planning for depression regions and contract planning for expansion delays) and how they are related to the ideas we use
}
%\os{
%Depression regions are typically used in the context of real-time planning~\cite{} where a heuristic is learned in an online fashion.
%It is used as 
%}

...
It is important to note that while using \mhastar ensures that a path will be found regardless of the  guidance that is provided, unuseful guidance may drive the search towards unuseful regions and waste computational resources.
}

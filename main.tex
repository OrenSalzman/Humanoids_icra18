...
%\captionsetup{format = plain}
  ...
  \subfigure[]
  {
  \includegraphics[width=0.265\textwidth]{fig/local_min_detection_1.pdf}
  ...
  \includegraphics[width=0.265\textwidth]{fig/local_min_detection_3.pdf}
  }  
  \hspace{-10mm}
  \subfigure[]
  {
  \label{fig:local_min4}
  \includegraphics[width=0.265\textwidth]{fig/local_min_detection_4.pdf}
  }
  \caption{%
    ...
    %
    \subref{fig:local_min2}~The function $\kappa(i,\omega_1)$ (dashed green) returns the minimal value $h(s_i)$ attained over the past~$\omega_1$ iterations (referred to  as the ``recent history'').
    %

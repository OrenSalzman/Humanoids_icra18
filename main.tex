...
%\captionsetup{format = plain}
  ...
  \subfigure[]
  {
  \includegraphics[width=0.2\textwidth]{fig/example_1.pdf}
  \label{fig:dynamic_heuristic1}
  }
  \subfigure[]
  {
  \label{fig:dynamic_heuristic2}
  \includegraphics[width=0.2\textwidth]{fig/example_2.pdf}
  }
  \subfigure[]
  {
  \label{fig:dynamic_heuristic3}
  \includegraphics[width=0.2\textwidth]{fig/example_3.pdf}
  }  
  \subfigure[]
  {
  \label{fig:dynamic_heuristic4}
  \includegraphics[width=0.2\textwidth]{fig/example_4.pdf}
  }
	\vspace{-3mm}
  \caption{%
...
For pseudo-code describing the implementation of each specific function of our general pseudocode (Alg.~\ref{alg:main}), see Alg.~\ref{alg:instantiation}.
...
%\captionsetup{format = plain}
  ...
  {
  \includegraphics[width=0.225\textwidth]{fig/ed_plot.pdf}
  \label{fig:ed_plot}
...
%
  ...
  {
  \includegraphics[width=0.225\textwidth]{fig/h_plot.pdf}
  \label{fig:h_plot}

...
\os{emphasize that in contrast to existing approaches we \emph{identify} when to ask for help}
...
The multiple heuristics that MHA* can use allows naturally to dynamically add and remove heuristics~\cite{INL15} or to automatically calibrate the weight given to each heuristic~\cite{PNAL15}.
...
\os{generalize to multiple queues}
